        ...
        Callback = function(val)
            ...
            if val then
                local function setup(room)
                    ...
                    door:WaitForChild("Open").Played:Connect(
                        function()
                            h.delete()
                        end
                    )

                    door.AncestryChanged:Connect(
                        function()
                            h.delete()
                        end
                    )
            ...
            if val then
                ...
                local function setup(room)
                    ...
                    if assets then
                        local subaddcon
                        subaddcon =
                            assets.DescendantAdded:Connect(
                            function(v)
                                check(v)
                            end
                        )
                ...
                local function check(v)
                    if v:IsA("Model") and (v.Name == "LeverForGate" or v.Name == "KeyObtain") then
                        ...
                        elseif v.Name == "LeverForGate" then
                            ...
                            v.PrimaryPart:WaitForChild("SoundToPlay").Played:Connect(
                                function()
                                    h.delete()
                                end
                            )
                ...
                addconnect =
                    ...
                    function(v)
                        if table.find(entitynames, v.Name) then
                            repeat
                                task.wait()
                            until plr:DistanceFromCharacter(v:GetPivot().Position) < 1000 or
...
local ToggleScreech =
    Tab:CreateToggle(
    {
        ...
        Callback = function(val)
            ...
            if val then
                local attacksound =
                    plr:WaitForChild("PlayerGui").MainUI.Initiator.Main_Game.RemoteListener.Modules.Screech.Attack
                ...
                addconnect =
                    ...
                    function(v)
                        if v.Name == "Screech" then
                            repeat
                                task.wait()
                                game.ReplicatedStorage:WaitForChild("EntityInfo"):WaitForChild("Screech"):FireServer(
                                    true
                                )
                        ...
                        for i, v in pairs(paper:WaitForChild("UI"):GetChildren()) do
                            if v:IsA("ImageLabel") and v.Name ~= "Image" then
                                for i, img in pairs(hints:GetChildren()) do
                                    if
                                        img:IsA("ImageLabel") and img.Visible and
                                            v.ImageRectOffset == img.ImageRectOffset
                                     then
