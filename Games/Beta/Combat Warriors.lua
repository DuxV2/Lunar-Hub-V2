...
for i, v in pairs(
    getconnections(game:GetService("Players").LocalPlayer.Character.Humanoid:GetPropertyChangedSignal("Jump"))
) do
    v:Disable()
end
for i, v in pairs(
    getconnections(game:GetService("Players").LocalPlayer.Character.Humanoid:GetPropertyChangedSignal("WalkSpeed"))
) do
    v:Disable()
end
for i, v in pairs(
    getconnections(game:GetService("Players").LocalPlayer.Character.Humanoid:GetPropertyChangedSignal("JumpPower"))
) do
    v:Disable()
end
for i, v in pairs(
    getconnections(game:GetService("Players").LocalPlayer.Character.Humanoid:GetPropertyChangedSignal("HipHeight"))
) do
    v:Disable()
end
...
local event =
    ...
    function()
        if game:GetService("Players").LocalPlayer.Character then
            for i, v in pairs(
                getconnections(
                    game:GetService("Players").LocalPlayer.Character.Humanoid:GetPropertyChangedSignal("WalkSpeed")
                )
            ) do
                v:Disable()
            end
...
local Remotes = {}
local NetworkEnvironment =
    getmenv(rawget(rawget(require(game.ReplicatedStorage.Framework.Nevermore), "_lookupTable"), "Network"))
...
local function getClosest()
    ...
    for i, v in pairs(game.Players:GetPlayers()) do
        if
            v.Character ~= nil and v ~= Players.LocalPlayer and v.Character:FindFirstChild("HumanoidRootPart") ~= nil and
...
local function getClosestToMouse()
    ...
    for i, v in pairs(Players:GetPlayers()) do
        if
            v ~= Players.LocalPlayer and v.Character:FindFirstChild("Humanoid") and v.Character.Humanoid.Health > 0 and
                    ...
                    function()
                        ...
                        if c_player.Character:FindFirstChild("SemiTransparentShield").Transparency == 1 then
                            ...
                            hitremote:FireServer(
                                weapon,
                                c_player.Character:FindFirstChild("HumanoidRootPart"),
                                weapon.Hitboxes.Hitbox,
                                c_player.Character:FindFirstChild("HumanoidRootPart").Position
                            )
                            hitremote:FireServer(
                                weapon,
                                c_player.Character:FindFirstChild("HumanoidRootPart"),
                        ...
                        if humanoid then
                            humanoid.AnimationPlayed:Connect(
                                function(track)
                                    ...
                                    if
                                        (lp.Character and lp.Character:FindFirstChild("Head") and
...
workspace.PlayerCharacters.DescendantAdded:Connect(
    function(e)
        pcall(
            function()
...
PlayerMain:Toggle(
    {
        ...
        Callback = function(bool)
            ...
            UIS.InputBegan:connect(
                function(UserInput)
                    if
                        _G.Toggled and UserInput.UserInputType == Enum.UserInputType.Keyboard and
                            UserInput.KeyCode == Enum.KeyCode.Space
                     then
                        Action(
...
PlayerMain:Toggle(
    {
        ...
        Callback = function(bool)
            ...
            while Flying do
                local move =
                    game.Players.LocalPlayer.Character.Humanoid.MoveDirection * (library.flags["FlySpeedValue"]) * 4
                    ...
                    function()
                        if aimbot and holdingm2 then
                            ...
                            if aimbotLocked and retard ~= nil then
                                local whereHeGonnaBe =
                                    retard.Character.HumanoidRootPart.CFrame +
                                    (retard.Character.HumanoidRootPart.Velocity * library.flags["AimbotPrediction"] +
                                        Vector3.new(0, .1, 0))
                                workspace.CurrentCamera.CFrame =
                                    CFrame.lookAt(workspace.CurrentCamera.CFrame.Position, whereHeGonnaBe.Position)
            ...
            function(o)
                if library.flags["autoairdrop"] then
                    ...
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                        Airdrop:WaitForChild "Crate".Base.CFrame
                    wait(.2)
        ...
        if rawget(v, "removeKillFeedIdx") then
            ...
            v.render = function(gg)
                if gg.props then
                    ...
                    if
                        (library.flags["KillSay"] and tostring(whoKilled) == LocalPlayer.Name and
                            tostring(whoDied) ~= LocalPlayer.Name)
                     then
